      ...
      <div className="min-w-full">
        ...
        <div className="sticky top-0 z-10 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700">
          <div className="grid grid-cols-8 border-b border-r">
            {/* Top-left search bar */}
            <div className="border-b border-r p-2 relative bg-slate-50 dark:bg-slate-800">
            ...
            {weekDays.map((day, index) => (
              <div key={index} className="border-b border-r p-2 text-center text-sm font-medium bg-slate-50 dark:bg-slate-800">
